        ...
        <div className="container w-80 border-2 p-4 rounded-2xl mb-8 ">
          ...
          <div className="flex gap-4 items-center">
            ...
            <div className="flex flex-col">
              <p className="font-semibold ">Graduate Trainee</p>
              <a className="font-semibold text-sm text-slate-400">Civica</a>
            </div>
          </div>
          <p className="mt-4 text-xs text-slate-400">April 2023 - July 2023</p>
        </div>
        {/* Company 1 DESCRIPTION */}
        <ul className="text-sm flex flex-col gap-3 ml-5 list-disc">
          <li>
      ...
      <div>
        <div className="container w-80 border-2 p-4 rounded-2xl mt-10 mb-8">
          ...
          <div className="flex gap-2 items-center">
            ...
            />
            <div className="flex flex-col">
              <p className="font-semibold ">QA Trainee</p>
              <a className="font-semibold text-sm text-slate-400">
                DXC Technology
              </a>
            </div>
          </div>
          <p className="mt-4 text-xs text-slate-400">June 2022 - July 2022</p>
        </div>
        {/* Company 1 DESCRIPTION */}
        <ul className="text-sm flex flex-col gap-3 ml-5 list-disc ">
          <li>
